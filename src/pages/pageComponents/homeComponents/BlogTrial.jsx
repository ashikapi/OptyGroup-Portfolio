...
const BlogTrial = () => {
  ...
  return (
    <div className='pt-10 pb-10 pl-2 pr-2 bg-gray-300'>
      <div className='container mx-auto'>
        {/* Section title */}
        <div className='text-center mb-10'>
          <h5 className='text-xl font-bold text-white'>Our Blog Posts</h5>
          ...
          {currentBlogs.map((details, index) => (
            <div key={index} className='space-y-4'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <hr className='w-full border-b-2 border-white' />
              </div>
      ...
      <div className='flex justify-center items-center mt-5'>
        <NavLink to={'/blog'}>
         <button className='flex justify-center items-center text-[rgb(245,124,0)] px-6 py-2 bg-white rounded-md
          text-xl font-bold'>
                <p>Read more</p>
