...
const BusinessTrial = () => {
    ...
    return (
            ...
            <div className='w-screen'>
                ...
                <div className='flex justify-center items-center mb-20'>
                    <div className='lg:grid grid-cols-2 gap-20 lg:space-y-0 space-y-10'>
                        {businessInfo[0].businessDetails.slice(0,4).map((detail, idx) => (
                            <div key={idx}>
        ...
        <NavLink to={'/services'}>
         <button className='flex justify-center items-center text-[rgb(245,124,0)] px-6 py-3 bg-white rounded-md
...
export default BusinessTrial; // Exporting the OurBusiness component
