          ...
          <div className="w-full max-w-7xl flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-20 px-6">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start gap-10">
                <h1 className="text-lg lg:text-xl font-semibold text-white">About Us</h1>
              </div>

              {/* Main title for the hero section */}
              <h1 className="text-xl lg:text-2xl font-bold text-white font-mono uppercase tracking-wide leading-tight">
                <span className=''>Get to Know Us:</span>  Our Story, Vision, and Commitment to Excellence
              </h1>
            </div>
...
export default AboutHero; // Exporting the CommonHero component
